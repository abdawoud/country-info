...
var countries =
    ...
    {name:'Occupied Palestine', code:'972', towLetters:'PS', threeLetters:'PSE'},
...
function getInfoByCountryName(countryName, callback) {
    if(typeof countryName != "undefined" || typeof callback != "function"){
        ...
        callback({error: 'Error in parameters'});
    }
};

function getInfoByDialNumber(dialNumber, callback) {
    if(typeof dialNumber != "undefined" || typeof callback != "function"){
        for(var i = 0; i < countries.length; i++){
...
function getInfoByThreeLettersISO(threeLetters, callback) {
    if(typeof threeLetters != "undefined" || typeof callback != "function"){
        for(var i = 0; i < countries.length; i++){
...
function getInfoByTwoLettersISO(twoLetters, callback) {
    if(typeof twoLetters != "undefined" || typeof callback != "function"){
        for(var i = 0; i < countries.length; i++){
